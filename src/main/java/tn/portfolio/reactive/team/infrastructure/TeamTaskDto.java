...
public record TeamTaskDto(UUID id, String name, String description, UUID projectTaskId, TeamTaskStatus status, UUID assigneeId, Integer actualTimeSpentHours, Integer actualTimeSpentMinutes, UUID teamId) {
