...
class ProjectTest {
    ...
    void addsTask() {
        ...
        Project project = Project.create(id, "test project", "testing", now, endDate, TimeEstimation.fromMinutes(60), "name", "email");
    ...
    void completesTask() {
        ...
        ProjectTaskId taskId = new ProjectTaskId(UUID.randomUUID());
        ProjectTaskId taskId2 = new ProjectTaskId(UUID.randomUUID());
        Project project = Project.create(id, "test project", "testing", now, endDate, TimeEstimation.fromMinutes(61), "name", "email");
        Project withTask = project.addTask(taskId, "task name", "some description", TimeEstimation.fromMinutes(60));
